...
- **书架随主题** -- 首页 3D 书架的展台底色与书配色随主题切换(Archive 深舞台 / Draft 浅展台)。每本书书皮由该书 accent 派生(Archive 深彩 / Draft 粉彩,彩色书皮 ADR-0020),一排书呈彩色书墙;accent 色板按书名 hash 分配。两套书皮纹理在主题切换时换 texture,不重建 3D 场景。
